...
int main() {
	int op,op2, i, k = 0, flight_numb[12], seats[12], n_flight;
	...
	while (op <= 0 && op > 3) {
		...
		if (op == 1) { // OPITON 01 FOR CONSULT
			...
			printf("\n\n\n############################################\n");
			printf("##     OPTIONS MENU  - [01]CONSULT           ##\n");
